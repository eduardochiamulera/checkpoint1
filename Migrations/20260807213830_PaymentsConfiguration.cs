        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false, collation: "utf8mb4_0900_ai_ci")
                    ...
                    ActivePaymentMarker = table.Column<int>(type: "int", nullable: true, computedColumnSql: "CASE WHEN `Status` IN (1, 2) THEN 1 ELSE NULL END", stored: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Payments", x => x.Id);
                    table.CheckConstraint("CK_Payments_Amount_Positive", "`Amount` > 0");
                    table.CheckConstraint("CK_Payments_Currency_Iso4217", "CHAR_LENGTH(`Currency`) = 3 AND `Currency` = UPPER(`Currency`)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PaymentStatusTransitions_DifferentStatuses", "`FromStatus` <> `ToStatus`");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Payments",
                columns: new[] { "EnrollmentId", "ActivePaymentMarker" },
                unique: true);
